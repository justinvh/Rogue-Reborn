...
#include <hat/engine/snd_local.h>
#include <hat/engine/snd_codec.h>
#include <hat/engine/client.h>

#ifdef USE_OPENAL

#include <hat/engine/qal.h>
...
=================
*/
static void S_AL_RawSamples(int stream, int samples, int rate, int width, int channels, const byte * data, float volume)
{
	ALuint          buffer;
	ALuint          format;
