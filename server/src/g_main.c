...
// Rogue Reborn - Server Specific
vmCvar_t		    rr_weaponsAllowed;
...
static cvarTable_t gameCvarTable[] = {
  ...
  // Rogue Reborn - Server specific
  {&rr_weaponsAllowed, "rr_weaponsAllowed", "", CVAR_SERVERINFO | CVAR_USERINFO | CVAR_LATCH, 0, qfalse},
  {&pm_allowLeaning, "sv_allowLean", "1",  CVAR_SERVERINFO | CVAR_USERINFO | CVAR_LATCH, 0, qfalse},
  {&pm_allowLeaningWithMovement, "sv_allowLeanWithMovement", "0", CVAR_SERVERINFO | CVAR_USERINFO | CVAR_LATCH, 0, qfalse},
