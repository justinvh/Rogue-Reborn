...
EXTERN void jpeg_make_d_derived_tbl JPP((j_decompress_ptr cinfo, JHUFF_TBL * htbl, d_derived_tbl ** pdtbl));
...
EXTERN boolean jpeg_fill_bit_buffer JPP((bitread_working_state * state,
										 register bit_buf_type get_buffer, register int bits_left, int nbits));
...
EXTERN int jpeg_huff_decode JPP((bitread_working_state * state,
								 register bit_buf_type get_buffer, register int bits_left, d_derived_tbl * htbl, int min_bits));
